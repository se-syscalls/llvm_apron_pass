...
bb7:                                              ; preds = %bb4
  ...
  %uadd.i = tail call { i32, i1 } @llvm.uadd.with.overflow.i32(i32 %tmp8, i32 %count) #4
  %tmp14 = extractvalue { i32, i1 } %uadd.i, 1
  %tmp15 = extractvalue { i32, i1 } %uadd.i, 0
...
bb7:                                              ; preds = %bb4
  ...
  %tmp12 = getelementptr inbounds %struct.thread_info* %tmp11, i32 0, i32 6, i32 0
  %tmp13 = load i32* %tmp12, align 4
  %uadd.i = call { i32, i1 } @llvm.uadd.with.overflow.i32(i32 %tmp8, i32 %count) #4
  %tmp14 = extractvalue { i32, i1 } %uadd.i, 1
  %tmp15 = extractvalue { i32, i1 } %uadd.i, 0
  %tmp16 = icmp ugt i32 %tmp15, %tmp13
  %or.cond = or i1 %tmp14, %tmp16
...
bb19:                                             ; preds = %bb16
  ...
  %tmp24 = load i32* %tmp23, align 4
  %uadd.i.i = call { i32, i1 } @llvm.uadd.with.overflow.i32(i32 %buf, i32 %count) #4
  %tmp25 = extractvalue { i32, i1 } %uadd.i.i, 1
  %tmp26 = extractvalue { i32, i1 } %uadd.i.i, 0
...
bb7.i:                                            ; preds = %bb4.i
  ...
  %uadd.i.i = call { i32, i1 } @llvm.uadd.with.overflow.i32(i32 %tmp8.i, i32 %count) #4
  %tmp14.i = extractvalue { i32, i1 } %uadd.i.i, 1
  %tmp15.i = extractvalue { i32, i1 } %uadd.i.i, 0
...
bb24:                                             ; preds = %bb21
  ...
  %tmp29 = load i32* %tmp28, align 4
  %uadd.i.i = call { i32, i1 } @llvm.uadd.with.overflow.i32(i32 %buf, i32 %count) #4
  %tmp30 = extractvalue { i32, i1 } %uadd.i.i, 1
  %tmp31 = extractvalue { i32, i1 } %uadd.i.i, 0
...
bb22:                                             ; preds = %.lr.ph.split.us
  ...
  %uadd.i.us = tail call { i32, i1 } @llvm.uadd.with.overflow.i32(i32 %tmp25, i32 %tmp20) #4
  %tmp31 = extractvalue { i32, i1 } %uadd.i.us, 1
  %tmp32 = extractvalue { i32, i1 } %uadd.i.us, 0
...
bb22.i.i:                                         ; preds = %.lr.ph.split.us.i.i
  ...
  %uadd.i.us.i.i = call { i32, i1 } @llvm.uadd.with.overflow.i32(i32 %tmp25.i.i, i32 %tmp20.i.i) #4
  %tmp31.i.i = extractvalue { i32, i1 } %uadd.i.us.i.i, 1
  %tmp32.i.i = extractvalue { i32, i1 } %uadd.i.us.i.i, 0
...
bb7:                                              ; preds = %bb
  %tmp8 = call { i32, i32 } asm sideeffect "call __get_user_${3:P}", "={ax},={edx},0,i,~{dirflag},~{fpsr},~{flags}"(i32* %tmp4, i32 4) #4, !srcloc !7
  %tmp9 = extractvalue { i32, i32 } %tmp8, 0
  %tmp10 = icmp eq i32 %tmp9, 0
  br i1 %tmp10, label %bb11, label %SYSC_sendfile.exit, !prof !6

bb11:                                             ; preds = %bb7
  %tmp12 = extractvalue { i32, i32 } %tmp8, 1
