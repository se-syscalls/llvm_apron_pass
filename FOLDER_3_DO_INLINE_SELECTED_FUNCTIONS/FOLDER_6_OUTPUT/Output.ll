...
bb8:                                              ; preds = %bb6
  %tmp9 = call { i32*, i64 } @get_user(i32* %tmp, i64 4)
  %tmp10 = inttoptr i32 0 to i32*
...
bb23:                                             ; preds = %bb21
  ...
  %tmp25 = call { i32*, i64 } @get_user(i32* %tmp, i64 4)
  %tmp26 = inttoptr i32 0 to i32*
  %tmp27 = add i64 0, 0
...
bb34:                                             ; preds = %bb32
  %tmp35 = call { i32*, i64 } @get_user(i32* %tmp24, i64 4)
  %tmp36 = inttoptr i32 0 to i32*
